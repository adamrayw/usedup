                        ...
                        <div className='space-y-4 md:w-1/2 w-full'>
                            ...
                            <div>
                                ...
                                <div class="flex items-center mb-4">
                                    <input id="tipe-bahan-bakar-diesel" type="radio" name="tipeBahanBakar" value="Diesel" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" />
                                    <label for="tipe-bahan-bakar-diesel" class="block ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                        Diesel
                                    </label>
                                </div>
                                <div class="flex items-center mb-4">
                                ...
                                <div class="flex items-center mb-4">
                                    <input id="tipe-bahan-bakar-hybrid" type="radio" name="tipeBahanBakar" value="Hybrid" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" />
                                    <label for="tipe-bahan-bakar-hybrid" class="block ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                        Hybrid
                                    </label>
                                </div>
                                <div class="flex items-center mb-4">
