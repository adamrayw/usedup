        ...
        <>
            <form>
                ...
                <div className="relative md:ml-16">
                    ...
                    <div className="flex absolute inset-y-0 right-0 items-center px-3 bg-gray-200 hover:cursor-pointer rounded-r-lg transition-all active:bg-slate-300" onClick={onSearch}>
